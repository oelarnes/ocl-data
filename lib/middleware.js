...
const resolvers = {
  ...
  OCLEvent: {
    ...
    async standingsJpgURL(parent) {
      ...
      const config = (0, _db.getFreshDbConfig)().htciapi;
...
`;
      ...
      if ((data === null || data === void 0 ? void 0 : data.url) !== undefined) {
        await (0, _db.executeRun)(`UPDATE event SET standingsJpgURL = $standingsJpgURL WHERE id = $eventId`, {
          $eventId: parent.id,
  ...
  Pick: {
    otherCardNames(parent) {
      var _parent$otherCardName;

      return ((_parent$otherCardName = parent.otherCardNamesString) === null || _parent$otherCardName === void 0 ? void 0 : _parent$otherCardName.split('\n')) || [];
    },
