...
const resolvers = { 
    ...
    Mutation: {
        ...
        updatePlayer: (_, {playerId, playerInput}) => Player.findOne({id: playerId}).then(
            (player) => (Object.assign(player, playerInput))
        ),
        deletePlayer: (_, {playerId}) => Player.remove({id: playerId}),
